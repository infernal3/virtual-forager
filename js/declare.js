...
const TOOLS = [null,
    ...
    {name: "Rusty Chainsaw", lore: "It's rusty but can still cut down trees.",    sweep: 17,  cost: 4000, speed: 1050},
    {name: "Chainsaw", lore: "Cuts down a huge amount of logs.",                  sweep: 19,  cost: 10000, speed: 300},
    {name: "Polished Chainsaw", lore: "It's faster than an ordinary Chainsaw.",   sweep: 19,  cost: 40000, speed: 170},
    ...
    {name: "Molten Axe", lore: "It's hotter than Lava. It's molten hot!",         sweep: 160, cost: 7500000, speed: 40},
    {name: "Diamond Axe", lore: "Made from pure diamonds.",                       sweep: 60,  cost: 24000000, speed: 16},
    {name: "Mythical Axe", lore: "Only heard of in obscure myths, until now.",    sweep: 250, cost: 120000000, speed: 37},
    {name: "Molten Chainsaw", lore: "Molten hot mechanized glory.",               sweep: 480, cost: 800000000, speed: 35},
...
const S_DATA = {logs: {
    ...
    Oak: 3, Birch: 25, Spruce: 200,Palm: 1500,Crimson: 8500,Willow: 4000, Pine: 25000,Mangrove: 366000
}};
const SHOPS = [null,
