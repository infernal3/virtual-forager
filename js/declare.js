...
const delayCalc = () => Math.max(100,(TOOLS[data.currentTool].speed * (data.current.toughness + 1)))
const CBS = (e, t, y) => {
...
const T_DATA = [null,
    ...
    {name: "Pine", xp: 13750, completeXPLow: 80000, completeXPHigh: 100000, toughness: 470, baseLogs: 90, req: 100, cute_name: "Pinerise Peak"},
...
const TOOLS = [null,
    ...
    {name: "Molten Axe", lore: "It's hotter than Lava. It's molten hot!", sweep: 95, cost: 3750000, speed: 40},
    {name: "Diamond Axe", lore: "Made from pure diamonds.", sweep: 60, cost: 24000000, speed: 16},
    {name: "Molten Chainsaw", lore: "Combining molten lava and a Chainsaw somehow works.", sweep: 235, cost: 175000000, speed: 35},
    {name: "Infinity Axe", lore: "???", sweep: 480, cost: 2147483647, speed: 32},
]
const S_DATA = {logs: {
    Oak: 1, Birch: 10, Spruce: 50, Palm: 275, Crimson: 900, Willow: 1700, Pine: 2000, Mangrove: 14000
}, cores: {
    Oak: 3, Birch: 25, Spruce: 200, Palm: 1500, Crimson: 10000, Willow: 4000, Pine: 25000, Mangrove: 610000
}}
