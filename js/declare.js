...
const CBT = (e, t) => {
    el(`root_button_${t}`).textContent = e;
};
...
const T_DATA = [
    ...
    { name: "Crimson", xp: 240, completeXPLow: 6000, completeXPHigh: 8000, toughness: 72, baseLogs: 38, req: 50, height: 381, cute_name: "The Volcano" },
    ...
    { name: "Pine", xp: 27500, completeXPLow: 890000, completeXPHigh: 999999, toughness: 240, baseLogs: 170, req: 100, height: 471, cute_name: "Pinerise Peak" },
    { name: "Mangrove", xp: 486, completeXPLow: 11000, completeXPHigh: 13500, toughness: 55, baseLogs: 94, req: 125, height: 384, cute_name: "Mangrove Marsh" },
];
const TOOLS = [
    null,
    ...
    { name: "Mythical Axe", lore: "Cuts trees down with the power of... myths?", sweep: 250, req: 100, cost: 180000000, speed: 37 },
    { name: "Molten Chainsaw", lore: "Cuts trees down with fire. Now a chainsaw.", sweep: 480, req: 100, cost: 640000000, speed: 35 },
...
const UPG2 = [
    null,
    { name: "Pure Sweep Buff", lore: "Increase the sweep of all tools by +10%.", max: 5, tiers: [1, 5, 10, 25, 100, Infinity] },
    { name: "Pure Efficiency", lore: "Increase the cut speed of all tools by +10%.", max: 5, tiers: [1, 5, 10, 25, 100, Infinity] },
    { name: "Pure Tree Gifts", lore: "Rare rewards from trees are +20% more common.", max: 5, tiers: [1, 5, 10, 25, 100, Infinity] },
    { name: "Unlock Prestige", lore: "Purchase this upgrade to find out what it does!", max: 1, tiers: [10000, Infinity] },
];
